  ...
  return (
    <div>
      <div className="grid justify-items-center gap-y-8  ml-28 grid-cols-4 w-10/12   text-2xl font-medium font-sans font-normal text-center border-black  pt-28  text-black">
        ...
        <h2 className="mb-6 col-start-2 col-span-2">
          Download csv file of the data by selecting options below
        </h2>

        <select
          className="col-start-2 col-span-1 focus:outline-none  rounded border-blue-700 border-2 text-gray-700 selectList1 mx-10"
          value={deptState}
          onChange={(e) => {
        ...
        <select
          className="col-start-3 col-span-1 focus:outline-none selectList2 rounded border-blue-700 border-2 text-gray-700"
          value={criteriaState}
          onChange={(e) => {
        ...
        <form method="GET" className="mt-8 col-start-2 col-span-2">
          <input
            type="text"
            className="py-2 q rounded border-blue-700 border-2 h-10 w-48 pl-4 focus:outline-none text-lg text-gray-700"
            placeholder={questionState || "Search by question"}
            autocomplete="off"
            onChange={(e) => {
        ...
        <button
          onClick={csvHandler}
          className="shadow-md col-start-2 w-6/12 col-span-2  mt-4  h-16 bg-white  hover:bg-blue-500 text-blue-700 text-lg font-semibold hover:text-white py-2 px-4 border border-blue-800 hover:border-transparent rounded transition delay-100 duration-200 ease-in-out"
        >
          Download CSV
        </button>
        {}
